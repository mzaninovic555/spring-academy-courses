...
public class RewardNetworkImpl implements RewardNetwork {
	...
	public RewardConfirmation rewardAccountFor(Dining dining) {
		...
		Account dinningAccount = accountRepository.findByCreditCard(dining.getCreditCardNumber());
		Restaurant restaurant = restaurantRepository.findByMerchantNumber(dining.getMerchantNumber());
		MonetaryAmount monetaryAmount = restaurant.calculateBenefitFor(dinningAccount, dining);
		AccountContribution accountContribution = dinningAccount.makeContribution(monetaryAmount);
		accountRepository.updateBeneficiaries(dinningAccount);
